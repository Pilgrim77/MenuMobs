...
public enum ConfigElement {
    ...
    FIXED_MOB("fixedMob","superbas11.configgui.fixedMob",new String[]{""},STRING , FixedMobEntry.class, FixedEntityArrayEntry.FixedPlayerArrayEntry.class),
    ...
    ConfigElement(String key, String langKey, String defaultString, Property.Type propertyType) {
        this.key = key;
    ...
    ConfigElement(String key, String langKey, String[] defaultString, Property.Type propertyType, Class<? extends GuiConfigEntries.IConfigEntry> clazz,Class<? extends GuiEditArrayEntries.IArrayEntry> arrayClazz) {
        this.key = key;
        this.langKey = langKey;
        this.propertyType = propertyType;
        this.EntryClass = clazz;
        this.ArrayEntryClass = arrayClazz;
        this.Setting = Reference.config.get(Configuration.CATEGORY_GENERAL,key,defaultString, I18n.format(langKey + ".tooltip"), STRING);
}

    ConfigElement(String key, String langKey, String defaultString, Property.Type propertyType, double min, double max, Class<? extends GuiConfigEntries.IConfigEntry> clazz) {
    ...
    public void syncConfig() {
        ...
        if (this.ArrayEntryClass != null)
            this.Setting.setArrayEntryClass(this.ArrayEntryClass);
        if (hasMinMax)
